Post.find_or_create_by!(id: 100) do |post|
  post.id = 100,
  post.user_id = 1,
...
Post.find_or_create_by!(id: 101) do |post|
  post.id = 101,
  post.user_id = 1,
...
Post.find_or_create_by!(id: 102) do |post|
  post.id = 102,
  post.user_id = 1,
...
Post.find_or_create_by(id: 103) do |post|
  post.id = 103,
  post.user_id = 1,
...
Post.find_or_create_by(id: 104) do |post|
  post.id = 104,
  post.user_id = 2,
...
Post.find_or_create_by(id: 105) do |post|
  post.id = 105,
  post.user_id = 2,
...
Post.find_or_create_by(id: 106) do |post|
  post.id = 106,
  post.user_id = 2,
...
Post.find_or_create_by(id: 107) do |post|
  post.id = 107,
  post.user_id = 2,
...
Post.find_or_create_by(id: 108) do |post|
  post.id = 108,
  post.user_id = 3,
...
Post.find_or_create_by(id: 109) do |post|
  post.id = 109,
  post.user_id = 3,
...
Post.find_or_create_by(id: 110) do |post|
  post.id = 110,
  post.user_id = 3,
